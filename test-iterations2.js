...
async function testIterations() {
  ...
  try {
    ...
    try {
      ...
      console.log(`Could not get teams via teamApi: ${teamErr.message}`);
      ...
      try {
        ...
        console.log(`Could not get teams via coreApi either: ${coreErr.message}`);
      }
    }
